...
class FosRestConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @template TValue
     * @param TValue $value
     * @default {"enabled":false,"service":null,"default_format":null,"throw_exception_on_unsupported_content_type":false,"decoders":{"json":"fos_rest.decoder.json"},"array_normalizer":{"service":null,"forms":false}}
