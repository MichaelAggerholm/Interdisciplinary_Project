 ...
 */
class getHardwarePlacementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HardwarePlacementRepository' shared autowired service.
     *
     * @return \App\Repository\HardwarePlacementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HardwarePlacementRepository.php';

        return $container->privates['App\\Repository\\HardwarePlacementRepository'] = new \App\Repository\HardwarePlacementRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
