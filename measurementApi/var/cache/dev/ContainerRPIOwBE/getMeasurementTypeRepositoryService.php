 ...
 */
class getMeasurementTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MeasurementTypeRepository' shared autowired service.
     *
     * @return \App\Repository\MeasurementTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MeasurementTypeRepository.php';

        return $container->privates['App\\Repository\\MeasurementTypeRepository'] = new \App\Repository\MeasurementTypeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
