 ...
 */
class getHardwareUnitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HardwareUnitRepository' shared autowired service.
     *
     * @return \App\Repository\HardwareUnitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HardwareUnitRepository.php';

        return $container->privates['App\\Repository\\HardwareUnitRepository'] = new \App\Repository\HardwareUnitRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
