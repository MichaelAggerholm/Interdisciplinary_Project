 ...
 */
class getHardwareUnittypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HardwareUnittypeRepository' shared autowired service.
     *
     * @return \App\Repository\HardwareUnittypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HardwareUnittypeRepository.php';

        return $container->privates['App\\Repository\\HardwareUnittypeRepository'] = new \App\Repository\HardwareUnittypeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
